...
export const AttendanceQRCode = forwardRef<HTMLDivElement, AttendanceQRCodeProps>(
    ...
    return (
      <div ref={ref} className="rounded-2xl border border-border bg-card p-5 shadow-sm">
        ...
        <div className="mt-4 rounded-xl border border-dashed border-border bg-muted/40 p-4">
          <div className="mx-auto flex w-44 items-center justify-center rounded-lg bg-white p-3">
            <QRCodeSVG
              value={displayTicket}
              size={160}
              level="M"
