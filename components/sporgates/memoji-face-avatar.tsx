  ...
  return (
    <div className={`relative ${sizeClasses[size]}`}>
      <svg viewBox="0 0 100 100" className="h-full w-full">
        ...
        <path d="M 32 42 Q 38 40 44 42" stroke={hairColor} strokeWidth="2" fill="none" strokeLinecap="round" />
        <path d="M 56 42 Q 62 40 68 42" stroke={hairColor} strokeWidth="2" fill="none" strokeLinecap="round" />
        <path d="M 50 52 Q 48 58 47 60" stroke={skinTone} strokeWidth="1.5" fill="none" strokeLinecap="round" opacity="0.4" />
        <path d="M 50 52 Q 52 58 53 60" stroke={skinTone} strokeWidth="1.5" fill="none" strokeLinecap="round" opacity="0.4" />
        <path d="M 40 65 Q 50 68 60 65" stroke="#E89B9B" strokeWidth="2" fill="none" strokeLinecap="round" />
        <rect x="42" y="80" width="16" height="12" fill={skinTone} rx="2" />
        <path d="M 30 92 Q 35 85 42 82 L 58 82 Q 65 85 70 92" fill="#003C66" />
