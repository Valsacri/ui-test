    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-[#003C66] via-[#003C66]/95 to-[#FC8936]/20 relative overflow-hidden">
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <div className="absolute top-20 left-10 w-72 h-72 bg-[#FC8936]/10 rounded-full blur-3xl" />
          <div className="absolute bottom-20 right-10 w-96 h-96 bg-[#003C66]/20 rounded-full blur-3xl" />
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[500px] h-[500px] bg-[#FC8936]/5 rounded-full blur-3xl" />
        </div>
        ...
        <div className="relative z-10 container mx-auto px-4 py-16 md:py-24">
          ...
          <div className="grid md:grid-cols-3 gap-6 max-w-6xl mx-auto mb-16">
            ...
            <Card className="bg-white/95 backdrop-blur-xl p-6 space-y-4 border-2 border-white/20 hover:border-[#FC8936]/50 transition-all hover:shadow-2xl hover:-translate-y-1">
              ...
              <h3 className="text-xl font-semibold text-[#003C66]">For Athletes</h3>
              ...
              <ul className="space-y-2">
                <li className="flex items-start gap-2 text-sm">
                  <CheckCircle2 className="w-4 h-4 text-[#FC8936] mt-0.5 flex-shrink-0" />
            ...
            <Card className="bg-white/95 backdrop-blur-xl p-6 space-y-4 border-2 border-[#FC8936] hover:shadow-2xl transition-all md:-translate-y-2">
              ...
              <h3 className="text-xl font-semibold text-[#003C66]">For Organizers</h3>
              <p className="text-sm text-muted-foreground leading-relaxed">
            ...
            <Card className="bg-white/95 backdrop-blur-xl p-6 space-y-4 border-2 border-white/20 hover:border-[#FC8936]/50 transition-all hover:shadow-2xl hover:-translate-y-1">
              ...
              <h3 className="text-xl font-semibold text-[#003C66]">For Sponsors</h3>
              <p className="text-sm text-muted-foreground leading-relaxed">
          ...
          <div className="bg-white/95 backdrop-blur-xl rounded-3xl shadow-2xl p-8 max-w-4xl mx-auto border border-white/20">
            <div className="text-center mb-8">
              <h3 className="text-2xl font-semibold text-[#003C66] mb-2">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              <div className="flex items-start gap-3">
                <div className="w-10 h-10 rounded-xl bg-[#FC8936]/10 flex items-center justify-center flex-shrink-0">
                  <Target className="w-5 h-5 text-[#FC8936]" />
                </div>
                <div>
                  <h4 className="font-semibold text-[#003C66] mb-1">AI Goal Tracking</h4>
              ...
              <div className="flex items-start gap-3">
                <div className="w-10 h-10 rounded-xl bg-[#FC8936]/10 flex items-center justify-center flex-shrink-0">
                  <Zap className="w-5 h-5 text-[#FC8936]" />
                </div>
                <div>
                  <h4 className="font-semibold text-[#003C66] mb-1">Sponsored Events</h4>
                  <p className="text-sm text-muted-foreground">
              ...
              <div className="flex items-start gap-3">
                <div className="w-10 h-10 rounded-xl bg-[#FC8936]/10 flex items-center justify-center flex-shrink-0">
                  <Award className="w-5 h-5 text-[#FC8936]" />
                </div>
                <div>
                  <h4 className="font-semibold text-[#003C66] mb-1">Complete Marketplace</h4>
                  <p className="text-sm text-muted-foreground">
        ...
        <div className="bg-white/95 backdrop-blur-xl rounded-3xl shadow-2xl border border-white/20 overflow-hidden">
          <Tabs defaultValue="signup" className="w-full">
            <TabsList className="grid w-full grid-cols-2 bg-gray-100/50 p-1">
              <TabsTrigger 
                value="signup"
                className="data-[state=active]:bg-white data-[state=active]:text-[#003C66] data-[state=active]:shadow-sm"
              >
                Sign Up
              </TabsTrigger>
              <TabsTrigger 
            ...
            <TabsContent value="signup" className="p-8 space-y-6">
              <div className="space-y-2 text-center">
                <h2 className="text-2xl font-semibold text-[#003C66]">Create your account</h2>
                <p className="text-sm text-muted-foreground">
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                <div className="space-y-2">
                  <Label htmlFor="name" className="text-[#003C66]">Full Name</Label>
                  <Input
                    id="name"
                    type="text"
                ...
                <div className="space-y-2">
                  <Label htmlFor="signup-email" className="text-[#003C66]">Email</Label>
                  <Input
                    id="signup-email"
                    type="email"
                ...
                <div className="space-y-2">
                  <Label htmlFor="signup-password" className="text-[#003C66]">Password</Label>
                  <Input
                    id="signup-password"
                    type="password"
              ...
              <div className="space-y-2">
                <Button variant="outline" className="w-full h-11 border-gray-200 hover:border-[#FC8936] hover:bg-[#FC8936]/5 transition-colors" type="button">
              ...
              <p className="text-xs text-center text-muted-foreground pt-2">
                ...
                <button className="text-[#003C66] hover:underline">Terms</button>
                {' '}and{' '}
                <button className="text-[#003C66] hover:underline">Privacy Policy</button>
              </p>
            </TabsContent>
            ...
            <TabsContent value="signin" className="p-8 space-y-6">
              <div className="space-y-2 text-center">
                <h2 className="text-2xl font-semibold text-[#003C66]">Welcome back</h2>
                <p className="text-sm text-muted-foreground">
              ...
              <form onSubmit={handleSignIn} className="space-y-4">
                <div className="space-y-2">
                  <Label htmlFor="signin-email" className="text-[#003C66]">Email</Label>
                  <Input
                    id="signin-email"
                    type="email"
                    placeholder="john@example.com"
                ...
                <div className="space-y-2">
                  <div className="flex items-center justify-between">
                    <Label htmlFor="signin-password" className="text-[#003C66]">Password</Label>
                    <button 
                      type="button"
                      className="text-xs text-[#003C66] hover:text-[#FC8936] transition-colors"
                    >
                      Forgot password?
                    </button>
                  </div>
